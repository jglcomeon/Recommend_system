...
def model_fn(features, labels, mode, params):
    ...
    eval_metric_ops = {'precision': tf.compat.v1.metrics.precision(labels, probabilities)}
    ...
    train_op = params['optimizer'].minimize(loss, tf.compat.v1.train.get_or_create_global_step())
